...
public class AquariumController {
    ...
    private float pH = 8;
    private pHSensor pH_sensor = new pHSensor();
    ...
    public void changepHLevel(float new_ph) {
        if(new_ph < 6 || new_ph > 10 || abs(new_ph-pH) > 2)
            alarm.turnOn();
        else pH_sensor.setValue(new_ph);
    }
    ...
    public pHSensor getpH_sensor() {return pH_sensor;}
